...
function MushroomShape({
  ...
  return (
    <>
      ...
      <path d={C_CAP_INNER} fill="none" stroke="rgba(0,0,0,0.12)" strokeWidth="12"/>
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        padding: "0 28px 56px",
        background: "linear-gradient(to top, rgba(1,4,12,0.92) 0%, rgba(1,4,12,0.50) 58%, transparent 100%)",
        ...
        <div style={{
          ...
          color: "rgba(238,228,210,0.80)", textAlign: "center", letterSpacing: "0.02em",
        ...
        <div style={{
          ...
          <span style={{
            fontFamily: "'Fredoka One', cursive", fontSize: "0.9rem", letterSpacing: "0.04em",
            color: swipeHintDir === "login" ? "#f5c040" : "rgba(200,190,170,0.65)",
            transition: "color 0.18s ease",
          }}>← Log In</span>
          <span style={{ color: "rgba(200,190,170,0.3)", fontSize: "0.7rem" }}>·</span>
          <span style={{
            fontFamily: "'Fredoka One', cursive", fontSize: "0.9rem", letterSpacing: "0.04em",
            color: swipeHintDir === "signup" ? "#f5c040" : "rgba(200,190,170,0.65)",
            transition: "color 0.18s ease",
          }}>Sign Up →</span>
        </div>
      </div>
